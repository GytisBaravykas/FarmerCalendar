...
import com.example.farmercalendar.AddNoteActivity
import com.example.farmercalendar.NotePreviewActivity
import java.util.*
...
class MainActivity : AppCompatActivity(), OnDayClickListener, OnSelectDateListener {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == RESULT_OK && requestCode == RESULT_CODE) {
            ...
            val eventDay = EventDay(calendar, com.example.farmercalendar.extensions.getDot())
            notes[eventDay] = note
